...
<div class="x_panel">
      ...
      <a class="btn btn-success title-right" style="margin-left: 90%;" href="{{ url ('setores/create')}}">Adicionar</a>
	...
	<div class="x_content">
		...
		<div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  <div class="x_title">
                    <h2>Setores {{-- <small>Users</small> --}}</h2>
              ...
              {{-- Iterar por cada item da lista $setores e chamá-la de $setor --}}
              @foreach($setores as $setor)
                ...
                <tr>
                  ...
                  <td>
                    @if($setor->operante) Sim @else Não @endif
                  </td>
                      ...
                      <td>
                        ...
                        <a  
                          ...
                          data-placement="bottom" 
                          title="Editar"
                          href="{{ url('setores/' . $setor->id . '/edit' )}}">  
