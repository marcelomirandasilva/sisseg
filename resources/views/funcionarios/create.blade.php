		...
		<div class="x_content">
			...
			<form method="POST" action="{{ url("funcionarios") }}" aria-label="{{ ('Register') }}">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-7">
                                <select id="secretaria" class="form-control{{ $errors->has('secretaria') ? ' is-invalid' : '' }}" name="secretaria" required autofocus>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-7">
                                <select id="setor" class="form-control{{ $errors->has('setor') ? ' is-invalid' : '' }}" name="setor"required autofocus>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-7">
                                <select id="cargo" class="form-control{{ $errors->has('cargo') ? ' is-invalid' : '' }}" name="cargo"required autofocus>
                            ...
                            <div class="col-md-7">
                                <select id="tipo" class="form-control{{ $errors->has('tipo') ? ' is-invalid' : '' }}" name="tipo" required autofocus>
                                    ...
                                    @foreach($valores as $valor)
                                         ...
                                         <option value="{{$valor->label}}">{{$valor->label}}</option>
