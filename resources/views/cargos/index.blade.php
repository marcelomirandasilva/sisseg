...
<div class="x_panel">
      ...
      <a class="btn btn-success title-right" style="margin-left: 90%;" href="{{ url ('cargos/create')}}">Adicionar</a>
	...
	<div class="x_content">
		...
		<div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  <div class="x_title">
                    <h2>Cargos {{-- <small>Users</small> --}}</h2>
              ...
              {{-- Iterar por cada item da lista $cargos e chamá-lo de $cargo --}}
